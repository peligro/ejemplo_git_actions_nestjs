...
@Module({
  ...
  controllers: [EjemploController, UploadController, CategoriasController, RecetasController, RecetasHelperController, ContactoController, UsuariosController, HealthController],
